...
rv100_model_int_2 <- glm(rv_100 ~ logabs_hbreak_resid +
                        median_spin + logabs_vbreak_resid + median_velo, 
                       data = med_sl_by_closer_new)
summary.lm(rv100_model_int_2)
...
rv100_relievers_predicted <- predict(rv100_model_int_2, newdata = med_sl_by_reliever_new, type = "response")
