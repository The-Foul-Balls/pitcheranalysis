...
avg_by_pitcher <- avg_by_pitcher %>%
        group_by(pitch) %>%
        mutate(outlier = ifelse(find_outlier(avg_spin), name, NA))
ggplot(avg_by_pitcher, aes(x=pitch, y=avg_spin)) +
  geom_boxplot() +
...
avg_by_pitcher <- avg_by_pitcher %>%
        group_by(pitch) %>%
        mutate(outlier = ifelse(find_outlier(avg_velo), name, NA))
ggplot(avg_by_pitcher, aes(x=pitch, y=avg_velo)) +
  geom_boxplot() +
...
avg_by_pitcher <- avg_by_pitcher %>%
        group_by(pitch) %>%
        mutate(outlier = ifelse(find_outlier(avg_hbreak), name, NA))
ggplot(avg_by_pitcher, aes(x=pitch, y=avg_hbreak)) +
  geom_boxplot() +
...
avg_by_pitcher <- avg_by_pitcher %>%
        group_by(pitch) %>%
        mutate(outlier = ifelse(find_outlier(avg_vbreak), name, NA))
ggplot(avg_by_pitcher, aes(x=pitch, y=avg_vbreak)) +
  geom_boxplot() +
...
avg_by_pitcher <- avg_by_pitcher %>%
        group_by(pitch) %>%
        mutate(outlier = ifelse(find_outlier(avg_plside), name, NA))
ggplot(avg_by_pitcher, aes(x=pitch, y=avg_plside)) +
  geom_boxplot() +
...
avg_by_pitcher <- avg_by_pitcher %>%
        group_by(pitch) %>%
        mutate(outlier = ifelse(find_outlier(avg_plheight), name, NA))
ggplot(avg_by_pitcher, aes(x=pitch, y=avg_plheight)) +
  geom_boxplot() +
