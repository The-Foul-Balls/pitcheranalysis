...
```{r}
# Create a new response variable as the log transform of 'median_hbreak'
med_sl_by_pitcher$log_median_vbreak <- log(med_sl_by_pitcher$median_vbreak)


## Basic Log Model
log_model <- glm(log_median_vbreak ~ median_spin + median_velo + median_hbreak, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
summary(log_model)
...
## Interaction Model 1
log_model_int <- glm(log_median_vbreak ~ median_spin + median_velo + median_hbreak + median_spin*median_velo, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
summary(log_model_int)
...
log_model_int_2 <- glm(log_median_vbreak ~ median_spin + median_velo + median_hbreak + median_spin*median_velo  + median_velo*median_hbreak, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
summary(log_model_int_2)
