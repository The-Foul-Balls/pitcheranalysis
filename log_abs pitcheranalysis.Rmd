...
med_sl_by_pitcher$log_median_hbreak <- log(med_sl_by_pitcher$median_hbreak)

## Basic Log Model
log_model <- glm(log_median_hbreak ~ median_spin + median_velo + median_vbreak, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
summary(log_model)

residuals_log_model <- residuals(log_model)
fitted_values_log_model <- fitted(log_model)

plot(fitted_values_log_model, residuals_log_model,
     xlab = "Fitted Values",
     ylab = "Residuals",
...
## Interaction Model 1
log_model_int <- glm(log_median_hbreak ~ median_spin + median_velo + median_vbreak + median_spin*median_velo, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
...
log_model_int_2 <- glm(log_median_hbreak ~ median_spin + median_velo + median_vbreak + median_spin*median_velo  + median_velo*median_vbreak, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
...
View(med_sl_by_pitcher)

## Basic Log Model
log_model <- glm(log_abs_median_vbreak ~ median_spin + median_velo + log_abs_median_hbreak, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
summary(log_model)
...
## Interaction Model 1
log_model_int <- glm(log_abs_median_vbreak ~ median_spin + median_velo + log_abs_median_hbreak + median_spin*median_velo, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
summary(log_model_int)
...
log_model_int_2 <- glm(log_abs_median_vbreak ~ median_spin + median_velo + log_abs_median_hbreak + median_spin*median_velo  + median_velo*log_abs_median_hbreak, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
summary(log_model_int_2)
...
summary.lm(log_model)
summary.lm(log_model_int)
summary.lm(log_model_int_2) # going with model 3
```
...
```{r}
## Basic Log Model
hb_log_model <- glm(log_abs_median_hbreak ~ median_spin + median_velo + log_abs_median_vbreak, 
                      family = gaussian(link = "identity"), 
                       data = med_sl_by_pitcher)
...
summary.lm(hb_log_model_int)
summary.lm(hb_log_model_int_2)
