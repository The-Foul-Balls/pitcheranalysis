...
med_sl_by_pitcher <- med_sl_by_pitcher |> 
   mutate(abs_vbreak_resid = residuals(v_logabs_model))
...
med_sl_by_pitcher <- med_sl_by_pitcher |> 
   mutate(abs_hbreak_resid = residuals(h_logabs_model))

#histograms
med_sl_by_pitcher_scaled <- med_sl_by_pitcher |>
  select(median_spin, median_velo, median_hbreak, median_vbreak, abs_vbreak_resid, abs_hbreak_resid) %>%
  scale() |>
  as.data.frame()
